...
class InclusaoPraticaMa : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageButton9.setOnClickListener {
            val intent = Intent(this@InclusaoPraticaMa, TelaUser::class.java)
            startActivity(intent)
        }
        val imagem1 = findViewById<ImageButton>(R.id.imageButton10)
        imagem1.setOnClickListener {
            val intent = Intent(this@InclusaoPraticaMa, TelaJogoMain::class.java)
            startActivity(intent)
        }
    }
}